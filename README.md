...
scripts/og.mjs      renders the OG card, icons and favicon.ico from SVG
public/             static files copied verbatim (favicon.svg, favicon.ico, icons, og-image, robots, sitemap, _headers, llms.txt)
```
